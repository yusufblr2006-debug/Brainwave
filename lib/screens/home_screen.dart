...
class _CitizenHomeScreenState extends State<CitizenHomeScreen> {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Hello, Citizen 👋', style: AppTextStyles.labelLarge),
                              Text('Session: ${provider.sessionId.substring(0,8)}...',
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(child: _quickAction(Icons.record_voice_over, 'Digital\nAdvocate', const Color(0xFF9333EA), () => context.push('/advocate-call'))),
                              const SizedBox(width: 16),
                    ...
                    Padding(
                      ...
                      child: NeuCard(
                        padding: EdgeInsets.zero,
                        onTap: () => context.push('/case-detail', extra: DummyData.cases[0]),
                        child: Column(
                          children: [
                            Container(
                              height: 160,
  ...
  Widget _lawyerMiniCard(Map<String, dynamic> l) {
    return NeuCard(
      padding: const EdgeInsets.all(16),
      onTap: () => context.push('/lawyer-profile', extra: l),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Badge: ${l['badge']}', style: AppTextStyles.bodySmall.copyWith(color: AppColors.gold)),
                  ],
                ),
              ),
            ],
          ...
          Text('Rating: ${l['rating']} · ${l['experience']}', style: AppTextStyles.bodySmall),
          const Spacer(),
          GradButton(text: 'Consult', onPressed: () => context.push('/lawyer-profile', extra: l), small: true),
        ],
      ),
    );
  }
