...
class AppTextStyles {
  ...
  static final displayLarge = _poppins.copyWith(fontSize: 28, fontWeight: FontWeight.w700, color: AppColors.textDark, letterSpacing: -0.5);
  static final displayMedium = _poppins.copyWith(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textDark, letterSpacing: -0.5);
  static final displaySmall = _poppins.copyWith(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.textDark);
  
  static final headlineMedium = _poppins.copyWith(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textDark);
  
  static final labelLarge = _poppins.copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textDark);
  static final labelMedium = _poppins.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textDark);
  
  static final bodyLarge = _poppins.copyWith(fontSize: 16, fontWeight: FontWeight.w400, color: AppColors.textDark);
  static final bodyMedium = _poppins.copyWith(fontSize: 14, fontWeight: FontWeight.w400, color: AppColors.textMid);
  static final bodySmall = _poppins.copyWith(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.textMid);

  static final buttonText = _poppins.copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white);
}
